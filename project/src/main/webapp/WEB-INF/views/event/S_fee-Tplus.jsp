...
<table width="1100" border="0" style="margin: auto;">
  <tr style="height: 90px;">
	...
	<tr align="center" valign="middle" class="titletr">
		...
		<td class="titleSubck" onclick="location.href='/project/s_fee_tp.action';"><font color="#ffffff">IT끼리 플러스</font></td>
		<td class="titleSub" onclick="location.href='/project/s_fee_rwp.action';">레인보우포인트</td>
...
<tr height="120" align="center">
	<td bgcolor="#f4f4f4" style="border-right: 10px solid #ffffff;">
	<b>IT끼리 T내는 요금상품</b>에<br/>
	- 가입중인 고객님<br/>
	</td>
	<td bgcolor="#f4f4f4" style="border-right: 10px solid #ffffff;">
	- SK텔레콤 이용기간이<br/>
	<b>2년이 지난 장기가입</b> 고객님<br/>
	</td>
	<td bgcolor="#f4f4f4">
	- SK텔레콤 고객과<br/>
	<b>통화량이 많은</b> 고객님
...
<tr>
	<td colspan="3">
		<h2><font color="#e74258">어떤 고객님들이</font> 사용하면 좋을까요?</h2>
	</td>	
</tr>
<tr>
	<td colspan="3">
	SK텔레콤 고객님께 꼭 맞는 할인프로그램을 추천합니다.
	</td>	
</tr>
...
<tr height="200">
	<td>
	<h3 align="center">이용요금</h3>
	</td>
	<td style="padding-left: 30px;">
	- 별도의 이용 요금은 없습니다.<br/>
	- IT끼리 IT 내는 요금 가입 고객이 별도로 신청만 하면 혜택을 받으실 수 있습니다.
	</td>
	<td align="center">
    <img src="/project/resources/images/event/bn_enable_free.png" width="253" height="133" alt=""/></td>
</tr>
...
<tr height="">
	<td colspan="3">
		<h2>IT끼리 PLUS <font color="#e74258">할인 혜택</font>을 확인하세요.</h2>
	</td>	
</tr>
<tr><td colspan="3"></td></tr>
<tr><td bgcolor="#e40b2a" style="border-right: 10px solid #ffffff;"></td><td colspan="2" bgcolor="#333333"></td></tr>
<tr><td colspan="3"></td></tr>
<tr height="350">
	<td>
	<h3 align="center">IT끼리 PLUS<br/>
	할인 가입 시</h3>
	</td>
	<td colspan="2" align="center">
    <img src="/project/resources/images/event/bn_tplus_g1.png" width="756" height="281" alt=""/></td>
</tr>
<tr><td colspan="3"></td></tr>
<tr><td bgcolor="#e40b2a" style="border-right: 10px solid #ffffff;"></td><td colspan="2" bgcolor="#e7e7e7"></td></tr>
<tr><td colspan="3"></td></tr>
<tr height="350">
	<td>
	<h3 align="center">T끼리 PLUS<br/>
	할인 미가입 시</h3>
	</td>
	<td colspan="2" align="center">
    <img src="/project/resources/images/event/bn_tplus_g2.png" width="908" height="240" alt=""/></td>
</tr>
<tr><td colspan="3" bgcolor="#e7e7e7"></td></tr>
</table>
<br/>
