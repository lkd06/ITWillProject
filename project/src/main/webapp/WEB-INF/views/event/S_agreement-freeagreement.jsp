...
<table width="1100" border="0" style="margin: auto;">
  <tr style="height: 90px;">
	...
	<tr align="center" valign="middle" class="titletr">
		...
		<td class="titleSubck" onclick="location.href='/project/s_agree_fm.action';"><font color="#ffffff">요금약정할인제도</font></td>
...
<tr>
	<td colspan="3">
		<h2><font color="#e74258">어떤 할인혜택들</font>을 받을 수 있나요?</h2>
	</td>	
</tr>
<tr>
	<td colspan="3">요금상품별 사용기간에 따라 매월 요금할인혜택을 드립니다.</td>	
</tr>
<tr bgcolor="#333333">
	<td colspan="3"></td>
</tr>
...
<tr height="120">
	...
	<td bgcolor="#f4f4f4" style="border-right: 10px solid #ffffff; padding-left: 70px;">
	- 요금약정 할인 선택<br/>
	12개월 또는 24개월간 약정기간 선택
	</td>
...
<tr>
	<td colspan="6">
		<h2>가입방법 <font color="#e74258">확인</font>하고, 할인 혜택 <font color="#e74258">신청</font>하세요.</h2>
	</td>	
</tr>
...
<tr height="200">
    ...
    <img src="/project/resources/images/event/ico_join1 (1).gif" width="69" height="70" alt=""/><br/>
	필요서류 확인<br/>
	...
	<td align="center">
    <img src="/project/resources/images/event/ico_join1_2.gif" width="70" height="70" alt=""/><br/>
	매장찾기<br/>
	<img src="/project/resources/images/event/매장찾기.png" width="76" height="32" alt=""/></td>
	<td style="padding-left: 30px;">
    <b>필요서류를 확인 후 매장을 방문하여 신청하시거나, 고객센터로 신청하실 수<br/>
	있습니다.</b><br/>
	<font style="font-size: 12px;">고객센터 상담시간은 평일 09:00~18:00 입니다. 점심시간(12:00~13:00)에는 긴급 전문상담만<br/>
		가능합니다. (무선-분실, 습득, 통화품질, 로밍, IT map, 유선-장애 및 해지 상담)</font><br/>
		<b>각 매장별 업무시간이 다를 수 있으니 업무시간을 꼭 확인하세요.</b>
	</td>
</tr>
<tr><td colspan="6" bgcolor="#e7e7e7"></td></tr>

<tr><td colspan="6" bgcolor="#e7e7e7"></td></tr>
<tr><td colspan="6" height="50"></td></tr>
<tr><td colspan="6" align="center"><img src="/project/resources/images/event/요금약장할인제도 자세히보기 버튼.png" width="267" height="60" alt=""/></td></tr>
</table>
<br/>
