...
<table width="1100" border="0" style="margin: auto;">
  <tr style="height: 90px;">
	...
	<tr align="center" valign="middle" class="titletr">
		<td class="titleSub"	onclick="location.href='/project/s_all_sal.action';">척척할인</td>
		<td class="titleSubck" onclick="location.href='/project/s_all_t5.action';"><font color="#ffffff">IT high5 금융</font></td>
	</tr>
<tr>
	<td colspan="2"><br/><br/>
    <img src="/project/resources/images/event/5금융.png" width="1100" height="461" alt=""/></td>	
</tr>
</table>
<br/><br/>
...
<tr>
	<td colspan="2">
	<h3>IT high5 적금 시리즈</h3>
	</td>	
</tr>
<tr><td bgcolor="#333333" colspan="2"></td></tr>
<tr>
	<td align="center" bgcolor="#f7f7f7"><h5>
	SK텔레콤 고객만이<br/>
	누릴 수 있는<br/>
	<font color="#ea002c">우대 금리 상품</font></h5>
	</td>
	<td align="center">
    <img src="/project/resources/images/event/적금시리즈.png" width="820" height="218" alt=""/></td>
</tr>
...
<tr>
	<td>
	<h3>IT high5 금융 혜택</h3>
	시즌 상품 모두 가입으로 금융혜택을 확장하세요.
	</td>	
</tr>
...
<tr>
	...
	<td align="center">
    <img src="/project/resources/images/event/금융혜택.png" width="1038" height="212" alt=""/></td>
</tr>
...
<tr>
	<td colspan="2">
	<h3>IT high5 적금 상품 서비스</h3>
	</td>	
</tr>
<tr><td bgcolor="#333333" colspan="2"></td></tr>
<tr height="350">
	<td align="center" style="border-right: 1px solid #e6e6e6;">
    <img src="/project/resources/images/event/적금 시즌1.png" width="439" height="190" alt=""/><br/><br/>
	<img src="/project/resources/images/event/자세히보기.png" width="104" height="42" alt=""/></td>
	<td align="center">
    <img src="/project/resources/images/event/적금 시즌2.png" width="429" height="195" alt=""/><br/><br/>
