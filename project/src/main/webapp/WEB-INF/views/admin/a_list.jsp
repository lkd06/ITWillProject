	...
	<table width="1300" style="margin: auto;">
		...
		<c:forEach var="dto" items="${lists }">
			<tr style="border-bottom: 1px solid #e8e8e8; height: 50px;">
				...
				<td align="center">
					<input type="button" onclick="javascript:location.href='/project/updateAdmin_ok.action?phone=${dto.phone }&admin=O';" class="btn btn-primary py-3 px-4" value="관리자 전환">
					<input type="button" onclick="javascript:location.href='/project/signout2.action?phone=${dto.phone }';" class="btn btn-primary py-3 px-4" value="강제 탈퇴">
				</td>
			</tr>
		</c:forEach>
