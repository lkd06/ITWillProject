...
<table>
  <tr>     
    <th align="left" style="font-size:40px; color: #333333; font-weight:bold">${Hmap.get('brandName')} <br/></th>
...
<div align="center" style="margin: auto; background-color: #FFFFF0; padding:15px; text-align:center; font-weight:bold; font-size:20px; height:80px; width:80%">
...
<table>
<tr> 
	<th><h3 style="text-align:center;">어느 지역 가맹점을 찾으시나요?</h3>
	<span style="font-size:20px; text-align:center;"> &nbsp;&nbsp;	나는 &nbsp;&nbsp; </span>
		...
		<select id="regionop" style="width:120px; height:30px;  border-width: 0px 0px 1px 0px; text-align:center;"> 
	  	...
	  	<span style="font-size:20px;text-align:center;"> 에서 IT 멤버십&nbsp; <span style="color:red"> ${Hmap.get('brandName')} </span> 가맹점을 찾고 있어요. </span>
	</th>
 </table>
  <br><br>
