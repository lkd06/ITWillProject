...
<html lang="en">
  ...
  function sendIt(){
	  ...
	  f = document.replyUpdate;

	  f.action = "replyUpdate_ok.action";
...
#btn3 {
  ...
  <body>
    ...
    <br/>
    <form action="" name="replyUpdate" method="post">
    ...
    <tr>
        ...
        <td width="600px" colspan="4" style="padding-left: 15px;"><b style="color: #FF7012; font-size: 18px;">이름 ${dto1.name }</b><br/>
        <textarea name="content" id="content" style="width: 500px; height: auto; font-size: 20px;">${dto1.content}</textarea></td>
        <td width="100px" colspan="4" style="padding-left: 20px;"><b style="font-size: 15px;">${dto1.originalCreated }</b></td>   
        <td width="30px" colspan="4"><img width="60%" onclick="sendIt();"
