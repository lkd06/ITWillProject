...
function  sendIt1(){
	...
	f = document.myReply;
	f.action = "replyCreate_ok.action";
	f.submit();
  ...
  <body>
    ...
    <tr>
        ...
        <b style="font-size: 17px;">작성자</b><font style="font-size: 17px;">&nbsp;${dto.userName }</font>
        </td>
        <td>
        ...
        <b style="font-size: 17px;">등록일</b><font style="font-size: 17px;">&nbsp;${dto.created } </font>
        </td>
        <td width="200" align="center">
        <b style="font-size: 17px;">조회수</b><font style="font-size: 17px;">&nbsp;${dto.hitCount }</font>
        </td>
    </tr>
    <tr height="15"><td colspan="4" style="border-bottom: 2px solid; border-bottom-color: #ea002c;"></td></tr>
    <tr>
        <td style="padding-left: 30px; font-size: 20px;" colspan="4">
        <br/><br/>
        ${dto.content }<br/>
        <br/>
        <img src="${savePath}" style="width: 500px; height: auto;"/><br>       
        <br/><br/><br/>
        </td>
    </tr>    
    <tr>
...
--%>
        ...
        <button id="btn1" value="수정"  
	    onclick="javascript:location.href='boardListUpdate.action?num=${dto.num}&${params }';">수정</button>
		
	    <button id="btn2" value="삭제" name="delete" 
	    onclick="javascript:location.href='boardListDelete.action?num=${dto.num}&${params }';">삭제</button>
	
	    <button id="btn3" value="리스트"  
    ...
    <tr>
        ...
        <td width="30px" colspan="4"><img width="60%" onclick="javascript:location.href='replyUpdate.action?replyNum=${dto1.replyNum}&${params}';"
            src="<%=cp%>/resources/images/image8.JPG"></td>                                                                   
        <td width="30px" colspan="4"><img width="60%" onclick="javascript:location.href='replyDelete.action?replyNum=${dto1.replyNum}&${params }';"
            src="<%=cp%>/resources/images/image7.JPG"></td>
    ...
    <tr align="center">
        ...
        <c:if  test="${dataCount==0 }">
              <font style="font-size: 20px;">등록된 댓글이 없습니다</font>
        </c:if>
        </td>
    </tr>    
