...
public class MyUtil {
	...
	public String replyIndexList(int currentPage, int totalPage, String listUrl){
		...
		while(page <= totalPage && page <= (currentPageSetup + numPerBlock)){
			...
			if(page == currentPage){				
				...
				sb.append("<a href=\"" + listUrl + "replyPageNum=" + page + "\">"
						+ page + "</a>&nbsp;");
		...
		if(totalPage - currentPageSetup > numPerBlock){
			...
			sb.append("<a href=\"" + listUrl + "replyPageNum=" + page + "\">다음▶</a>&nbsp;");
